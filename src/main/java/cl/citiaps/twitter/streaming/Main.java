...
public class Main {
    ...
    public void doMain(String[] args){
	    ...
	    String keywords[] = {"entel", "entel_ayuda","movistarchile", "ayudamovistarcl", "vtrsoporte", "vtrchile", "womchile", "womteayuda", "virginmobile_cl","clarochile_cl","miclaro_cl"};
	    
	    fq.track(keywords);

	    twitterStream.addListener(listener);
	    twitterStream.filter(fq);  
		//MongoDBSelect getVtr = new MongoDBSelect();
		//getVtr.
		//MongoDBSelectExample mse = new MongoDBSelectExample();
		//mse.ejecutar();
		//ServiceFind serv= new ServiceFind();
		//serv.obtenerDatos();
    }
